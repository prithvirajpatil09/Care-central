...
"border-color: rgb(0, 0, 0);")
        ...
        self.pushButton = QtWidgets.QPushButton(selectAdmin)
        self.pushButton.setGeometry(QtCore.QRect(270, 410, 81, 31))
    ...
    def retranslateUi(self, selectAdmin):
        ...
        self.title.setText(_translate("selectAdmin", "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-weight:600; text-decoration: underline;\">Delete Admin</span></p></body></html>"))
        self.firstNameLabel.setText(_translate("selectAdmin", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">First Name : </span></p></body></html>"))
        self.lastNameLabel.setText(_translate("selectAdmin", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Last Name : </span></p></body></html>"))
        ...
        self.firstName.setText(_translate("selectAdmin", "first_name"))
        self.lastName.setText(_translate("selectAdmin", "last_name"))
        self.state.setText(_translate("selectAdmin", "state"))
        self.city.setText(_translate("selectAdmin", "city"))
        self.hospital.setText(_translate("selectAdmin", "hospital"))
        self.pushButton.setText(_translate("selectAdmin", "DELETE"))
