...
# Form implementation generated from reading ui file 'removeDispensary.ui'
#
...
class Ui_selectDispensary(object):
    def setupUi(self, selectDispensary):
        selectDispensary.setObjectName("selectDispensary")
        selectDispensary.resize(568, 464)
        selectDispensary.setWindowTitle("")
        self.title = QtWidgets.QLabel(selectDispensary)
        self.title.setGeometry(QtCore.QRect(140, 0, 321, 51))
        self.title.setObjectName("title")
        self.addButton = QtWidgets.QPushButton(selectDispensary)
        self.addButton.setGeometry(QtCore.QRect(220, 410, 131, 41))
        self.addButton.setObjectName("addButton")
        self.frame = QtWidgets.QFrame(selectDispensary)
        self.frame.setGeometry(QtCore.QRect(10, 60, 541, 341))
...
"font-weight: bold;")
    ...
    def retranslateUi(self, selectDispensary):
        ...
        self.title.setText(_translate("selectDispensary", "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-weight:600; text-decoration: underline;\">Remove Dispensary</span></p></body></html>"))
        self.addButton.setText(_translate("selectDispensary", "REMOVE"))
        self.nameLabel.setText(_translate("selectDispensary", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Name :</span></p></body></html>"))
        self.addressLabel.setText(_translate("selectDispensary", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Address :</span></p></body></html>"))
        self.contactLabel.setText(_translate("selectDispensary", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Contact No. :</span></p></body></html>"))
        ...
        self.pinCodeLabel.setText(_translate("selectDispensary", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">Pin Code :</span></p></body></html>"))
        ...
        self.address.setPlaceholderText(_translate("selectDispensary", "Street, Landmark, Area"))
        self.pinCode.setText(_translate("selectDispensary", "PinCode"))
        self.state.setText(_translate("selectDispensary", "State"))
        self.city.setText(_translate("selectDispensary", "City"))
        self.contact.setText(_translate("selectDispensary", "1234567890"))
        self.name.setText(_translate("selectDispensary", "Name"))
        self.IDLabel.setText(_translate("selectDispensary", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600;\">ID :</span></p></body></html>"))
        self.dispensaryID.setText(_translate("selectDispensary", "DispensaryID"))
