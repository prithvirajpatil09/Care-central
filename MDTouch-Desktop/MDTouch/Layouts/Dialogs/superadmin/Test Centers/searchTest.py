...
# Form implementation generated from reading ui file 'searchTest.ui'
#
...
"font-weight: bold;")
    ...
    def retranslateUi(self, searchTest):
        ...
        searchTest.setWindowTitle(_translate("searchTest", "Test"))
        self.searchButton.setText(_translate("searchTest", "Search"))
        self.text.setPlaceholderText(_translate("searchTest", "Enter Test Name"))
        self.okbutton.setText(_translate("searchTest", "close"))
        self.titleLabel.setText(_translate("searchTest", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; text-decoration: underline;\">Search Tests</span></p></body></html>"))
