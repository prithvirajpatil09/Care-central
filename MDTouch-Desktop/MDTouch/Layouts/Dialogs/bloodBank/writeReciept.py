...
# Form implementation generated from reading ui file 'writeReciept.ui'
#
...
class Ui_bloodReciept(object):
    def setupUi(self, bloodReciept):
...
"font-weight: bold;")
        ...
        self.retranslateUi(bloodReciept)
        QtCore.QMetaObject.connectSlotsByName(bloodReciept)

    def retranslateUi(self, bloodReciept):
