...
class Canvas(FingureCanvas):
    def __init__(self, parent = None, width =7, height = 4, dpi =100):
        ...
        means_men = (15,12 , 30, 35, 27,22)
        std_men = (2, 3, 4, 1, 2,0)

        means_women = (0, 2, 14, 22, 28, 3)
        std_women = (3, 5, 2, 3, 1,2)
        # Example data
        '''
...
class doctorAppointmentGraph(object):
    ...
    def retranslateUi(self, geographicalGraph):
        ...
        self.titleLabel.setText(_translate("geographicalGraph", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; text-decoration: underline;\">Half Year Report Of Doctors</span></p></body></html>"))
