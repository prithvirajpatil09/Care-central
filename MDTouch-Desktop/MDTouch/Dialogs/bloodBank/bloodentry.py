...
class bloodentry(object):
    def setup(self, bloodentry,grandparent):
...
"font-weight: bold;")
        ...
        self.retranslateUi(bloodentry,grandparent)
        QtCore.QMetaObject.connectSlotsByName(bloodentry)

    def retranslateUi(self, bloodentry,grandparent):
        ...
        self.events(bloodentry,grandparent)
