...
class addTestCenter(object):
    ...
    def retranslateUi(self, addTestCenter):
        ...
        self.title.setText(_translate("addTestCenter", "<html><head/><body><p align=\"center\"><span style=\" font-size:15pt; font-weight:600; text-decoration: underline;\">Add Test Center</span></p></body></html>"))
    ...
    def addTcFunction(self,parent):
        ...
        URL1 = "http://127.0.0.1:8000/api/testcentre/"
